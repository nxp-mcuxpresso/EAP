...
#ifndef EAP_PARAMETER_TEST_ALL_ON1
#define EAP_PARAMETER_TEST_ALL_ON1
/*******************************************************************/
/* Include */
/*******************************************************************/
 ...
 *
 */
LVM_InstParams_t InstParams_testAllOn1 = {
	/* General */
...
LVM_HeadroomParams_t HeadroomParams_testAllOn1 = {
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_testAllOn1 = {
	/* General parameters */
	.OperatingMode	 	 = LVM_MODE_ON, 							// LVM_MODE_ON or LVM_MODE_OFF / Bundle operating mode On/Bypass
	.SampleRate 		 = LVM_FS_8000, 							// LVM_FS_8000, LVM_FS_11025, LVM_FS_12000, LVM_FS_16000, LVM_FS_22050, LVM_FS_24000, LVM_FS_32000, LVM_FS_44100, LVM_FS_48000
