...
#ifndef EAP_PARAMETER_TEST_ALL_ON11
#define EAP_PARAMETER_TEST_ALL_ON11
/*******************************************************************/
/* Include */
/*******************************************************************/

#include "EAP_Parameter_TestAllOn_48000_2ch.h"
 ...
 *
 */
LVM_InstParams_t InstParams_testAllOn11 = {
	/* General */
...
LVM_HeadroomParams_t HeadroomParams_testAllOn11 = {
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_testAllOn11 = {
	/* General parameters */
	.OperatingMode	 	 = LVM_MODE_ON, 							// LVM_MODE_ON or LVM_MODE_OFF / Bundle operating mode On/Bypass
	.SampleRate 		 = LVM_FS_24000, 							// LVM_FS_8000, LVM_FS_11025, LVM_FS_12000, LVM_FS_16000, LVM_FS_22050, LVM_FS_24000, LVM_FS_32000, LVM_FS_44100, LVM_FS_48000
	.SourceFormat		 = LVM_MONO, 								// LVM_MONO or LVM_MONOINSTEREO or LVM_STEREO or LVM_5DOT1 or LVM_7DOT1
	...
	.PR_EQNB_NBands					= (LVM_UINT16)3,          		 // Number of bands 0 to LVM_EQNB_MAX_BANDS_NBR
    ...
    .CS_AP_SideHighPassCutoff = 1200, 								// SideBoost HighPassFilter Corner Frequency: 20 to 24000 Hz
    .CS_AP_SideLowPassCutoff  = 1300,  							// SideBoost LowPassFilter Corner Frequency: 20 to 24000 Hz
