...
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_allEffectOff[LVM_EQNB_MAX_BANDS_NBR] 	= {
																{15,10000,100},   	// gain(dB), freq(Hz) , Qfactor *100
																{ 15,10000,100},
																{15,15000,100},
																{0,2000,96},
																{0,0,0},
...
LVM_InstParams_t InstParams_allEffectOff = {
	...
	.MaxBlockSize 	  = 1024,      	    			  /* Maximum processing block size max = 480 */
...
LVM_ControlParams_t	ControlParamSet_allEffectOff = {
	...
	.SampleRate 		 = LVM_FS_96000, 			// LVM_FS_8000, LVM_FS_11025, LVM_FS_12000, LVM_FS_16000, LVM_FS_22050, LVM_FS_24000, LVM_FS_32000, LVM_FS_44100, LVM_FS_48000
	...
	.EQNB_NBands = (LVM_UINT16)1,          			// Number of bands 0 to LVM_EQNB_MAX_BANDS_NBR
	...
	.BE_EffectLevel = (LVM_INT16)LVM_BE_15DB, 		// LVM_BE_0DB or LVM_BE_3DB or LVM_BE_6DB or LVM_BE_9DB or LVM_BE_12DB or LVM_BE_15DB;
	...
	.LM_EffectLevel = LVM_LM_EXTREME, 				// LVM_LM_GENTLE or LVM_LM_MEDIUM or LVM_LM_EXTREME
...
/*Crossover module parameter*/
	...
	.XO_cutoffFrequency = 5000,						//Cutoff frequency in Hz (range  = [60 Hz - 6 000 Hz])
#endif // ALGORITHM_XO
};
